...
router.get("/consultar-objetivo-x-lineas-accion", authMiddleware, (req, res) => {
...
router.get("/consultar-plan-accion-x-estrategia", authMiddleware, (req, res) => {
...
router.get("/consultar-periodo-evaluacion-x-id-indicador", authMiddleware, (req, res) => {
